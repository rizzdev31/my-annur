...
async function load() {
    ...
    try {
        const res = await api.get('/education/tahsin/jadwal-hari-ini')
...
// Group per kelas (mirror Flutter/Tahfidz): 1 kartu/kelas, pilih sesi relevan.
            ...
            <ul v-else class="space-y-3">
                <RouterLink v-for="g in groups" :key="g.kelasId" :to="{ name: 'tahsin-roster', params: { jadwalId: g.jadwalId } }"
                    ...
                    <div class="flex items-start gap-3">
                        <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-violet-500 to-violet-700 grid place-items-center shrink-0">
                            <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
                        </div>
