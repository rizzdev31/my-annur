...
const tanggal = ref('')
const jadwal = ref([])
const inval = ref([])   // kelas tahfidz yang Anda gantikan hari ini
        ...
        <template v-else>
            ...
            <template v-if="inval.length">
                ...
                <ul class="space-y-2 mb-5">
                    <RouterLink v-for="k in inval" :key="k.absensi_mengajar_id" :to="{ name: 'tahfidz-roster', params: { jadwalId: k.jadwal_id } }"
            ...
            <div v-if="!groups.length && !inval.length" class="pt-16 text-center text-sm text-gray-400">Anda belum memegang kelas tahfidz.</div>
